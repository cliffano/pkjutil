...
function __upgradeVersion(type, file, parseable) {
  pkjUtil = new PkjUtil(file);
...
function _upgradeVersionPatch(args) {
  __upgradeVersion('patch', args.parent.file, args.parseable);
}

function _upgradeVersionMinor(args) {
  __upgradeVersion('minor', args.parent.file, args.parseable);
}

function _upgradeVersionMajor(args) {
  __upgradeVersion('major', args.parent.file, args.parseable);
}
